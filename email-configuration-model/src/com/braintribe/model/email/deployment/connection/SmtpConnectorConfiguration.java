...
public interface SmtpConnectorConfiguration extends SendConnectorConfiguration, HasCredentials, HasProxy {

	final EntityType<SmtpConnectorConfiguration> T = EntityTypes.T(SmtpConnectorConfiguration.class);
