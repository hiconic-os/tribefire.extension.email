...
@RequestMapping(path = "v1/receive", method = HttpRequestMethod.GET, section = "Email", responseMimeType = "application/json", hideSerializedRequest = BooleanOverride.ENABLED, depth = "reachable")
